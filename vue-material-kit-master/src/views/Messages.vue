      ...
      <div class="container">
        <div class="md-layout">
          ...
          >
            ...
            <h4>
            Here at ChampGram, we've created a space where
            athletes of all levels and interests can come
            together to create one amazing community!
            </h4>
            <br />
      ...
      <div class="section">
        <div class="container">
          <div class="md-layout">
            ...
            >
              <h2 class="title text-center">Sports Feed</h2>
          ...
          <div class="post">
              <div class="avatar"></div>
                <h3 class='username'>eastondavies09</h3>
                ...
                purus cursus dictum ornare a phasellus. A augue venenatis adipiscing.</p>
                  <img class="post-img" src="images/Placeholder.jpg" alt="placeholder" width="100%" height="200px">
